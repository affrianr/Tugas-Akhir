            ...
            <div class="col-xs-12">
              <div class="box">
				...
				<a href="webpage_weibull.php"><button class="btn btn-success" type="button" data-toggle="modal"><i class="fa fa-plus"></i> Visualization Tools</button></a>
                  ...
                  <!-- <?php
                      $command = escapeshellcmd('python3 /coba.py');
...
<?php
                                ...
                                ?>
<br>Reliability<input type="text" value="<?php echo $reliabilityn; ?>" class="form-control"></br>
<br>Failure Rate<input type="text" value="<?php echo $failureraten; ?>" class="form-control"></br>
...
<?php
                                ...
                                ?>
<br>Reliability<input type="text" value="<?php echo $reliabilityw; ?>" class="form-control"></br>
<br>Failure Rate<input type="text" value="<?php echo $failureratew; ?>" class="form-control"></br>
...
<?php
                                ...
                                ?>
<br>Reliability<input type="text" value="<?php echo $reliabilityl; ?>" class="form-control"></br>
<br>Failure Rate<input type="text" value="<?php echo $failureratel; ?>" class="form-control"></br>
