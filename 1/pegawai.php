    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			  		<li><a href="kerusakan.php"><i class="fa fa-columns"></i><span>Kerusakan</span></a></li>
					...
					<li class="active"><a href="pegawai.php"><i class="fa fa-user"></i><span>Pegawai</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-user"></i> Pegawai</li>
          </ol>
        </section>
