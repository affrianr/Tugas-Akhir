    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i>Detail Kerusakan</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          $Id_kerusakan	= $_GET["Id_kerusakan"];
              ...
              $querykerusakan = mysqli_query ($konek, "SELECT *
							FROM kerusakan 
              ...
              while ($kerusakan = mysqli_fetch_array ($querykerusakan)){
                /* echo $kerusakan["kode_komponen_rusak"]; */
                
          ?>
          
                <input name="kode_komponen_rusak" type="text" class="form-control" value="<?php echo $kerusakan["kode_komponen_rusak"]; ?>" readonly />
          <?php
			        }
          ?>
                </div><!-- /.box-body -->
