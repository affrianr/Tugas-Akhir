        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        ...
			        <li><a href="parameter3.php"><i class="fa fa-university"></i><span>Detection</span></a></li>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
				<!-- <a href="#"><button class="btn btn-success" type="button" data-target="#ModalAddDosen" data-toggle="modal"><i class="fa fa-plus"></i> Add Administrator</button></a> -->
				<a href="#"><button class="btn btn-success" type="button" data-target="#ModalAddMahasiswa" data-toggle="modal"><i class="fa fa-plus"></i> Add Pegawai</button></a>
                  <br></br>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Tambah User Pegawai</h4>
						<br />
